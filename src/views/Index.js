                  ...
                  <Link to="/auth/login">
                    <div className="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg ease-linear transition-all duration-150">
                      <img
                        ...
                        src={require("assets/img/promo/promo-card-img04.svg").default}
                      />
                    </div>
                  </Link>
                  ...
                  <Link to="/profile">
                    <div className="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg ease-linear transition-all duration-150">
                      <img
                        ...
                        src={require("assets/img/promo/promo-card-img05.svg").default}
                      />
                    </div>
                  </Link>
                  <h5 className="text-xl font-semibold pb-4 text-center">
                  ...
                  <Link to="/landing">
                    <div className="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg ease-linear transition-all duration-150">
                      <img
                        alt="..."
                        className="align-middle border-none max-w-full h-auto rounded-lg"
                        src={require("assets/img/promo/promo-card-img06.svg").default}
                      />
                    </div>
                  </Link>
                  <h5 className="text-xl font-semibold pb-4 text-center">
        ...
        <div className="items-center flex flex-wrap">
          <div className="w-full md:w-6/12 mr-auto px-4 pt-24 md:pt-0">
            <img
              ...
              src={require("assets/img/pic-skills-mobile.png").default}
            />
          </div>
